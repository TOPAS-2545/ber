...
func makeFloat64(v float64) (encoder, error) {

    switch {
    case math.IsInf(v, 1):
        return byteEncoder(0x40), nil
    case math.IsInf(v, -1):
        return byteEncoder(0x41), nil
    case math.IsNaN(v):
        return byteEncoder(0x42), nil
    case v == 0.0:
        if math.Signbit(v) {
